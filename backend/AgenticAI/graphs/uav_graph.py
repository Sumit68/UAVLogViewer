...
from AgenticAI.nodes.llm_query_generator_node import llm_query_generator_node
from AgenticAI.nodes.query_executer_node import query_executor_node
...
def build_uav_graph():
    ...
    builder.add_edge("key_identifier", "llm_query_generator")
    builder.add_edge("llm_query_generator", "query_executor")
    builder.add_edge("query_executor", "factual_extractor")
